...
{
    public class DailyOrdersController : BaseReportController<CustomerReportsSearchModel, DailyOrdersListModel, DailyOrdersReportModel>
    {
        public DailyOrdersController(
            ...
            : base(baseReportFactory, customerReportsModelFactory, permissionService, logger, "~/Plugins/Reports.CustomReports/Views/CustomerReports/DailyOrders/DailyOrders.cshtml")
        {
